...
- 每日构建计划：凌晨 2 点（东八区）
- 当前构建开始时间：`2026-09-17 04:50:59 +08:00`，构建总耗时 `8.30` 分钟
- 当前 Nop 组件包版本号：`2.0.0-SNAPSHOT`
- 当前 Nop 源码变更版本：[ea39a4560f4b17f44b46307dfd9b099368014088](https://github.com/entropy-cloud/nop-entropy/tree/ea39a4560f4b17f44b46307dfd9b099368014088)
- 额外构建的 Nop 项目如下：
...
点击下载 [nop-idea-plugin-1.0-20260916.zip](./nop-idea-plugin-1.0-20260916.zip)，
完成后，进入 IDEA 的插件管理（`File -> Settings -> Plugins`），
点击齿轮图标，并选择 `Install Plugin from Disk ...`，再选中已下载的插件
`nop-idea-plugin-1.0-20260916.zip` 以将其安装到 IDEA 中。
...
点击下载
[nop-cli-2.0.0-BETA.1-20260916.jar](./io/github/entropy-cloud/nop-cli/2.0.0-BETA.1-20260916/nop-cli-2.0.0-BETA.1-20260916.jar)，
并在控制台执行相关命令：
...
${JAVA_HOME}/bin/java \
  -Dfile.encoding=UTF8 \
  -jar ./nop-cli-2.0.0-BETA.1-20260916.jar \
  gen -t=/nop/templates/orm \
  ./model/nop-demo.orm.xlsx
```

> 通过 `${JAVA_HOME}/bin/java -jar ./nop-cli-2.0.0-BETA.1-20260916.jar gen -h`
> 可查看 `gen` 子命令的详细参数说明。
